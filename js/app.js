(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            ...
            if (bodyLockStatus && e.target.closest(".menu__link")) functions_menuClose();
        }));
    }
...
***************************************************************************** */
    ...
    document.addEventListener("click", (e => {
        ...
        if (targetElement.closest(".search-block__btn")) targetElement.closest(".search-block").classList.add("open-search");
        if (!targetElement.closest(".search-block__btn") && !targetElement.closest(".search-block__field")) removeClasses(document.querySelectorAll(".search-block.open-search"), "open-search");
    }));
